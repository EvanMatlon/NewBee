var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<input type="text" class="form-control input-small" value="' + ((nRow.children)[1]).innerText + '">';
        ...
        function editsaveRow(oTable, nRow) {
            ...
            url='/api/exe_group/'+jqInputs[0].value+'/';
        ...
        table.on('click', '.delete', function (e) {
            ...
            if (window.XMLHttpRequest)
              ...
              {// code for IE6, IE5
            	xhr = new ActiveXObject("Microsoft.XMLHTTP");
             	  ...
             	  if(xhr.readyState==4) {
   				      //0：未初始化  1：读取中   2：已读取   3：交互中    4：完成
             		    if(xhr.status==200||xhr.status==405||xhr.status==404) {
             			      msg = xhr.responseText;
                              alert(msg);
             		    }
             	  }
            ...
            var dedata = {};
            url='/api/host_exe_group/'+aData[0]+'/';
