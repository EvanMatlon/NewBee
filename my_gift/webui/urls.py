...
urlpatterns = [
    ...
    url(r'host/$',login_required(views.HostViewSet.as_view()),name='host'),
    url(r'role/$',login_required(views.RoleViewSet.as_view()),name='role'),
    url(r'^exe_group/$',login_required(views.Exe_groupViewSet.as_view()),name='exe_group'),
    url(r'^host_exe_group/$',login_required(views.Host_exe_groupViewSet.as_view()),name='host_exe_group'),
    url(r'^mission/$',login_required(views.MissionViewSet.as_view()),name='mission'),

    # url(r'^mission/\?status=0$',login_required(views.MissionViewSet.as_view()),name='mission_status'),
    url(r'^finished_mission/$',login_required(views.Finished_missionViewSet.as_view()),name='finished_mission'),
